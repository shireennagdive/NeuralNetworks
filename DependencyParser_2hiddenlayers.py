...
class DependencyParserModel(object):
    ...
    def build_graph(self, graph, embedding_array, Config):
        ...
        with graph.as_default():
            ...
            weights_output = tf.Variable(
                tf.random_normal(shape=[Config.hidden_size, parsing_system.numTransitions()], stddev=0.1)) #
            #
            ...
            self.train_prediction = self.forward_pass(embeddings_layer_1, weights_input_2, bias_input_2,
                                                      weights_output, 2)
            ...
            self.test_pred = self.forward_pass(test_y1, weights_input_2, bias_input_2, weights_output, 2)
    ...
    def forward_pass(self, embed, weights_input, biases_input, weights_output, pass_number):
        """
        ...
        Implement the forward pass described in
